...
<asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Width="300px"></asp:TextBox>
        ...
        <tr>
            ...
            <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" Width="300px" Visible="false"></asp:TextBox>
                        <asp:Label ID="Label4" runat="server" Text="Re-Enter New Password:" Visible="false"></asp:Label>

           <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" Width="300px" Visible="false"></asp:TextBox>
